...
extern node *create_node(maybe_int val);
extern void insert_node(node *previous_node, node *new_node);
extern void append_value(node **tail, maybe_int val);
extern void insert_value(node *previous_node, maybe_int val);
...
extern node *lookup(node *head, maybe_int val);
